README_PID_FINAL_MOLASSES.txt
P&ID - Final Molasses Storage Area

How to run
1. Open AutoCAD Plant 3D 2025 or AutoCAD.
2. Run APPLOAD.
3. Load pid_final_molasses_304.lsp.
4. Run command PIDFINALMOL.

Scope
- Final molasses storage/transfer area.
- Drawing No: PID-304-FM.
- Equipment included: TK-304.
- Lines included: S-320.
