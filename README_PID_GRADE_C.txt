README_PID_GRADE_C.txt
P&ID - Grade Sugar C Crystallization Area

How to run
1. Open AutoCAD Plant 3D 2025 or AutoCAD.
2. Run APPLOAD.
3. Load pid_grade_c_303.lsp.
4. Run command PIDGRADEC.

Scope
- Grade C crystallization with Final Molasses off-page to TK-304.
- Drawing No: PID-303-C.
- Equipment included: TK-303, CR-303, CF-303, DR-303, CL-303.
- Lines included: S-315 to S-320.
